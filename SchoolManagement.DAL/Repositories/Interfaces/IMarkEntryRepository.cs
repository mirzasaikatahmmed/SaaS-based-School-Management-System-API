...
public interface IMarkEntryRepository
{
    ...
    Task<IReadOnlyList<MarkEntry>> GetForExamClassSectionAsync(Guid examId, Guid classId, Guid sectionId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<ExamScheduleSubject>> GetScheduleSubjectsAsync(Guid examId, Guid classId, Guid sectionId, CancellationToken cancellationToken = default);
